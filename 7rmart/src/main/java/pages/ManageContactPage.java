...
public class ManageContactPage {
	...
	@FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/contact/edit_contact?edit=1']")WebElement editIcon;
	@FindBy(xpath="//input[@id='phone']")WebElement addphoneno;
	@FindBy(xpath="//input[@id='email']")WebElement addemail;
	@FindBy(xpath="//textarea[@placeholder='Enter the Address']")WebElement addaddress;
	@FindBy(xpath="//textarea[@placeholder='Enter Delivery Time']")WebElement adddeliverytime;
	@FindBy(xpath="//input[@id='del_limit']")WebElement adddeliverychargelimit;
