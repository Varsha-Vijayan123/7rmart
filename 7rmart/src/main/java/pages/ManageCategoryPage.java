...
public class ManageCategoryPage {
	...
	@FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/category/edit?edit=2891&page_ad=1']")WebElement editIcon;
	@FindBy(xpath="//input[@id='main_img']")WebElement chooseFileButtonInAddNewCategory;
	@FindBy(xpath="//button[@name='update']")WebElement update;
	@FindBy(xpath="//div[@class='alert alert-success alert-dismissible']")WebElement alert;
	@FindBy(xpath="//b[text()='Fatal error']")WebElement errorException;
