...
public class ManageContactTest extends Base {
	...
	public void verifyUserIsAbletoUpdateContactinformation() throws IOException {
		...
		managecontactpage.clickEditIcon().addPhoneno(phoneno).addEmail(email).addAddress(address).addDeliveryTime(deliverytime).addDeliveryChargeLimit(deliverychargelimit).update();
