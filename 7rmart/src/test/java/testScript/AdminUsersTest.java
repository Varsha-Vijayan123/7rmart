...
public class AdminUsersTest extends Base {
	...
	public void verifyUserIsAbleToAddANewadminInAdminUsersTest() throws IOException {
		String loginUserName = ExcelUtilities.getStringData(1, 0, "LoginPage"); // Fetching username from Excel file.
																				// 1,0 represent cell position
		...
		// String loginUserNameAdmin = ExcelUtility.getstringData(1,0, "Admins"); //
		// Fetching username from Excel file. 1,0 represent cell position
		// String loginPasswordAdmin = ExcelUtility.getstringData(1,1, "Admins");
		FakerUtility fakerutility = new FakerUtility();
		String loginUserNameAdmin = fakerutility.createARandomFirstName(); // generating random username using
																			// FakerUtility
		String loginPasswordAdmin = fakerutility.createARandomFirstName();// Generating random password using
																			// FakerUtility
	...
	public void verifyUserIsAbleToUpdateDetailsOfAnExistingAdminInAdminUsersTest() throws IOException {
