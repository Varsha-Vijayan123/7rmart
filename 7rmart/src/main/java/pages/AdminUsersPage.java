...
public class AdminUsersPage {
	...
	// and @ class="small-box-footer"]")WebElement addAdminLink;
	@FindBy(xpath = "//a[@class='btn btn-rounded btn-danger']")
	WebElement addNewAdminButton;
	@FindBy(xpath = "//input[@id='username']")
	WebElement addNewAdminTextBox;
	@FindBy(xpath = "//input[@id='password']")
	WebElement passwordTextBoxAdmin;
	@FindBy(xpath = "//select[@id='user_type']")
	WebElement selectDropDown;
	@FindBy(xpath = "//button[@name='Create']")
	WebElement saveAdminButton;
	...
	@FindBy(xpath = "//select[@id='user_type']")
	WebElement editSelectdropdown;
	@FindBy(xpath = "//a[@href='https://groceryapp.uniqassosiates.com/admin/user/edit?edit=15579&page_ad=1']")
	...
	/*
	 * public void adminUserMoreInfo() { addAdminLink.click(); }
	 */
